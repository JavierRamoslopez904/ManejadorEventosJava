...
public class Botones extends javax.swing.JFrame {
    ...
    public Botones() {
        initComponents();
        setSize(700, 700);
        PrimerBoton.addActionListener(new App());
        SegundoBoton.addActionListener(new App2());
        TercerBoton.addActionListener(new App3());
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(PrimerBoton);

        SegundoBoton.setText("Segundo Boton");
        jPanel1.add(SegundoBoton);

        TercerBoton.setText("Tercer Boton");
        jPanel1.add(TercerBoton);
